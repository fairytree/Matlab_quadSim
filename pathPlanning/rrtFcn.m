%% CONVERT RRT.m INTO A FUNCTION (NOT DONE YET)
function rrtFcn()    
    ...
    static_saftey_margins = 0.5 * influence_margins; % static_saftey_margins has to be smaller than influence_margins
...
function random_point = generateRandomPoint(bounds_rrt, goal_frequency, goal)

...
function plotGraphSingleN(reference_signal,...
    ...
    % lgd.AutoUpdate = 'on';
    ytickformat('%.2f');
    plot(ctrl_inputs.Time, ctrl_inputs.Data(1,:) + mass * g, Color=color, LineWidth=line_width);
    ...
    ytickformat('%.2f');
    plot(ctrl_inputs.Time, ctrl_inputs.Data(2,:), Color=color, LineWidth=line_width, DisplayName='$\omega_x$');
    plot(ctrl_inputs.Time, ctrl_inputs.Data(3,:), Color=colors(2), LineWidth=line_width, DisplayName='$\omega_y$');
    plot(ctrl_inputs.Time, ctrl_inputs.Data(4,:), Color=colors(3), LineWidth=line_width, DisplayName='$\omega_z$');
